...
namespace devpodcasts.Services.Core.Test
{
    public class BasePodcastUpdaterTests : IClassFixture<DbFixture>
    {
        ...
        private readonly BasePodcastUpdater _testClass;
        private readonly Mock<ILogger<BasePodcastUpdater>> _loggerMock;
        private readonly Mock<IDbContextFactory> _contextMock;
        private readonly IConfiguration _configuration;


        public BasePodcastUpdaterTests(DbFixture dbFixture)
        {
            _configuration = dbFixture.Configuration;

            _loggerMock = new Mock<ILogger<BasePodcastUpdater>>();
            _contextMock = new Mock<IDbContextFactory>();

            _testClass = new BasePodcastUpdater(_loggerMock.Object, _contextMock.Object);
        }
